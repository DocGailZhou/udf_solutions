...
**Generated**: 2026-03-02 21:27:16  
**Date Range**: 2025-01-01 to 2026-03-02  
**Duration**: 425 days  
**Integration**: Connected to 38,927 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 6,499
...
- **Purchase Orders**: 15 procurement orders  
- **PO Line Items**: 7 order details
...
- **Purchase Orders**: 15 orders spanning 90-day historical period
...
- `PurchaseOrders.csv` - 15 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 7 line items with specifications
...
*Generation Parameters: 15 orders, 100 transactions, 15 events*  
