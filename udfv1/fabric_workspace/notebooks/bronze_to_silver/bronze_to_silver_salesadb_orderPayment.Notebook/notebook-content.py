...
# # Load Bronze Data to Silver Table - OrderPayment (ADB)
# 
# ## Overview
# Load OrderPayment sample data from Bronze lakehouse files into Silver lakehouse table.
# 
# ## Data Flow
# - **Source**: Bronze Lakehouse /Files/samples_databricks/sales/OrderPayment_Samples_ADB.csv
# - **Target**: Silver Lakehouse salesadb.OrderPayment table (Delta table)
...
SOURCE_PATH = f"abfss://{WORKSPACE_ID}@onelake.dfs.fabric.microsoft.com/{SOURCE_LAKEHOUSE_ID}/Files/samples_databricks/sales/OrderPayment_ADB.csv"
...
# Required columns from Model_Sales_Domain.ipynb OrderPayment table
required_columns = [
...
df = df.withColumn("TransactionId", col("TransactionId").cast(StringType()))
