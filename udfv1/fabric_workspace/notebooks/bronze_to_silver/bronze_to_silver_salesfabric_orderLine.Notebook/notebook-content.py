...
# # Load Bronze Data to Silver Table - OrderLine (Fabric)
# 
# ## Overview
# Load OrderLine sample data from Bronze lakehouse files into Silver lakehouse table.
# 
# ## Data Flow
# - **Source**: Bronze Lakehouse /Files/samples_fabric/sales/OrderLine_Samples_Fabric.csv
# - **Target**: Silver Lakehouse sales.OrderLine table (Delta table)
...
SOURCE_PATH = f"abfss://{WORKSPACE_ID}@onelake.dfs.fabric.microsoft.com/{SOURCE_LAKEHOUSE_ID}/Files/samples_fabric/sales/OrderLine_Samples_Fabric.csv"
