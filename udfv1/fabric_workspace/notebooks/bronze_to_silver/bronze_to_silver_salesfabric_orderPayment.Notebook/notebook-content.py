...
# # Load Bronze Data to Silver Table - OrderPayment (Fabric)
# 
# ## Overview
# Load OrderPayment sample data from Bronze lakehouse files into Silver lakehouse table.
# 
# ## Data Flow
# - **Source**: Bronze Lakehouse /Files/samples_fabric/sales/OrderPayment_Fabric.csv
# - **Target**: Silver Lakehouse sales.OrderPayment table (Delta table)
...
SOURCE_PATH = f"abfss://{WORKSPACE_ID}@onelake.dfs.fabric.microsoft.com/{SOURCE_LAKEHOUSE_ID}/Files/samples_fabric/sales/OrderPayment_Fabric.csv"
