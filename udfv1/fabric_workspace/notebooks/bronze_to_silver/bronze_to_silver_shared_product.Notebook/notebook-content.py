...
# # Load Bronze Data to Silver Table - Product
# 
# ## Overview
# Load Product sample data from Bronze lakehouse files into Silver lakehouse table.
# 
# ## Data Flow
# - **Source**: Bronze Lakehouse /Files/samples_fabric/shared/Product_Samples_Combined.csv
# - **Target**: Silver Lakehouse shared.Product table (Delta table)
...
SOURCE_PATH = f"abfss://{WORKSPACE_ID}@onelake.dfs.fabric.microsoft.com/{SOURCE_LAKEHOUSE_ID}/Files/samples_fabric/shared/Product_Samples_Combined.csv"
